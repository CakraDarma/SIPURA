				...
				>
					...
					{imageUrl ? (
						...
						<div className='flex flex-col items-center justify-center text-xs text-gray-400'>
							...
							<div className='mt-3'>
								<Button className='bg-black-light' disabled={disabled}>
									select
								</Button>
							</div>
						</div>
					...
					{imageUrl && !disabled && (
						...
						>
							<div className='flex items-center justify-center w-5 h-5 mt-4 mr-4 transition-all duration-300 bg-red-600 border border-solid rounded-md border-white/70 hover:h-6 hover:w-6'>
								<X
